...
def getWeather():
    ...
    weather = "http://api.openweathermap.org/data/2.5/weather?q={}&units=metric&APPID=9f5834ee3f9f42f1671bc72b4626f9e7".format(city) #API URL
...
username = "Tomek" #set username
password = "Tomek" #set password
